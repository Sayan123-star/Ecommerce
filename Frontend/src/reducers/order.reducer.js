...
// This reducer is use to show all the order done by the user
export const myOrdersReducer = (state={loggedOrders:[]},action)=>{
    switch (action.type) {
...
// This reducer is use to operate crud operation on the  orders 
...
// This reducer is use to show all the order done by the userto the admin
...
// this reducer is use to show the order details
